...
export default {
  ...
  methods: {
    ...
    validate() {
      let valid = true
      if (!this.register.username || this.register.username < 2 || this.register.username > 30) {
      ...
      if (!this.register.password || this.register.password < 2 || this.register.password > 30) {
